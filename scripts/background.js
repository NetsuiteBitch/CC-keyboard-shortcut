...
// function (){ f = window.location.href; f = f.replace(/&quicksort=[^&]*/,""); f = f.replace(/&sortcol=[^&]*/,""); f = f + '&sortcol=Item_MODIFIED_raw'; window.open(f,"_self");}
...
! function (e) {
    ...
    if (!localStorage.shortkeys) {
        ...
        localStorage.shortkeys =
            ...
            + "{\"key\": \"n n\",\"label\": \"function:next\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {document.getElementById('next').click();})()\"},"
            + "{\"key\": \"c c\",\"label\": \"function:cancel\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {NLInvokeButton(jQuery('[Value*=Cancel]').filter(':visible')[0]);})()\"},"
            ...
            + "{\"key\": \"c s v\",\"label\": \"function:export xls\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {jQuery('.uir-list-export-csv')[0].click()})()\"},"
            ...
            + "{\"key\": \"s b b\",\"label\": \"function:sandbox\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function () { f = window.location.host.split('.')[0]; newhost = f.endsWith('-sb1') ? f.substring(0,f.length-4):f + '-sb1'; window.open(window.location.href.replace(f,newhost),'_self');})()\"},"
            + "{\"key\": \"e m o\",\"label\": \"function:edit view\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function () {jQuery('#extreme-list-edit-button').click();})()\"},"
            + "{\"key\": \"n p a\",\"label\": \"function:next page\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function () {jQuery('.navig-next')[0].click();})()\"},"
            + "{\"key\": \"p p a\",\"label\": \"function:prev page\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function () {jQuery('.navig-prev')[0].click();})()\"},"
            // + "{\"key\": \"s r m\",\"label\": \"function:sort modified\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function (){ f = window.location.href; f = f.replace(/&quicksort=[^&]*/,''); f = f.replace(/&sortcol=[^&]*/,''); f = f + '&sortcol=Item_MODIFIED_raw'; window.open(f,'_self');})()\"},"
            // + "{\"key\": \"t t t\",\"label\": \"function:test\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (tstf)()\"},"
            ...
            + "{\"key\": \"u m l\",\"label\": \"csv job status\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/units/unitstypelist.nl'; window.open(f,'_self');})()\"},"
            ...
            + "{\"key\": \"b m n\",\"label\": \"bom list\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/manufacturing/bom.nl'; window.open(f,'_self');})()\"},"
            ...
            + "{\"key\": \"h e l\",\"label\": \"help center\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/help/helpcenter.nl'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"a i n\",\"label\": \"Adjust Inventory\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/invadjst.nl?whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"a i l\",\"label\": \"Adjust Inventory\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=InvAdjst'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n a i l\",\"label\": \"Adjust Inventory\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=InvAdjst'; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"a i w\",\"label\": \"Adjust Inventory\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/invwksht.nl?whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"b i n\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/inventory/binlist.nl'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"a b l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?searchtype=Transaction&Transaction_TYPE=Build'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n a b l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?searchtype=Transaction&Transaction_TYPE=Build'; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"a b n\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/build.nl'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n a b n\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/build.nl'; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"i c n\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/invcount.nl?whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n i c n\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/invcount.nl?whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"i c l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=InvCount'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n i c l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=InvCount'; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"m y s\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2091&whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n m y s\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2091&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"c a l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/site/hosting/scriptlet.nl?script=1453&deploy=1'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n c a l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/site/hosting/scriptlet.nl?script=1453&deploy=1'; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"a s l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=Build&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"s m o b\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/site/hosting/scriptlet.nl?script=43&deploy=1&compid=4287944_SB1&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"p m o b\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/site/hosting/scriptlet.nl?script=43&deploy=1&compid=4287944&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"m y s\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2091&whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n m y s\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2091&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"i n c\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/reporting/reportrunner.nl?cr=-200&whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n i n c\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/reporting/reportrunner.nl?cr=-200&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"g r o\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/crm/common/crmgrouplist.nl?whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n g r o\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/crm/common/crmgrouplist.nl?whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"n b t l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=BinTrnfr&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"b t l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/transactionlist.nl?Transaction_TYPE=BinTrnfr&whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"m y s\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2091&whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n m y s\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2091&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"c i r\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2114&whence='; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n c i r\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/search/searchresults.nl?searchid=2114&whence='; window.open(f,'_blank');})()\"},"
            + "{\"key\": \"w m l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/custom/custrecordentrylist.nl?rectype=612&sortcol=cfRECORD_4810_raw&sortdir=DESC&showall=T'; window.open(f,'_self');})()\"},"
            + "{\"key\": \"n w m l\",\"label\": \"bundles installed\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/common/custom/custrecordentrylist.nl?rectype=612&sortcol=cfRECORD_4810_raw&sortdir=DESC&showall=T'; window.open(f,'_blank');})()\"},"
            ...
            + "{\"key\": \"w o n\",\"label\": \"work order - new\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/workord.nl?record.subsidiary=2&record.location=5'; window.open(f,'_self');})()\"},"
            ...
            + "{\"key\": \"n w o n\",\"label\": \"newtab\",\"action\": \"javascript\",\"sites\": \"\",\"sitesArray\": [\"\"],\"activeInInputs\": true,\"blacklist\": false,\"code\": \"javascript: (function() {f = window.location.href.split('app/')[0] + 'app/accounting/transactions/workord.nl?record.subsidiary=2&record.location=5';if (!window.open(f)) location.href = f;})()\"},"
